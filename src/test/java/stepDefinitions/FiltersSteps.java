...
public class FiltersSteps {
    ...
    public void user_is_on_category_page(String categoryName) {
       /*  homePage.open();
        ...
        testContext.getHomePage().openMenShoesCategory();
        Assert.assertTrue(testContext.getCategoryPage().getProductCount() > 0, "Category has no products");
    ...
    public void user_applies_minimum_price_filter(String minPrice) {
        ...
        testContext.getCategoryPage().applyMinPrice(minPrice);
    ...
    public void filtered_results_should_match_price(Integer minPrice) {
        ...
        Assert.assertTrue(testContext.getCategoryPage().verifyAllPricesGreaterThanOrEqual(minPrice), "Prices not filtered correctly");
